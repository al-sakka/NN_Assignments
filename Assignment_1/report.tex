...
\begin{titlepage}
    ...
    \IfFileExists{cu_logo.png}{\includegraphics[width=0.22\textwidth]{cu_logo.png}}{}
    \hfill
    \IfFileExists{cufe_logo.png}{\includegraphics[width=0.27\textwidth]{cufe_logo.png}}{}

    \vfill
    {\Large \textbf{Department of Electronics and Communications Engineering}}\\[0.5cm]
    {\Huge \textbf{Neural Networks}}\\[0.8cm]
    {\Large \textbf{Assignment \#1 Report}}\\[1.5cm]
    ...
    \begin{tabular}{|c|c|}
    \hline
    \rowcolor{gray!25} \textbf{Name} & \textbf{Student ID} \\\hline
    Abdallah Essam Mohamed Mahmoud El-Sakka & 9220479 \\\hline
    \end{tabular}
    \end{center}

    \vfill
    \textbf{Submitted To:} Prof. Mohsen Rashwan\\[0.4cm]
    \textbf{Submission Date:} April 4, 2026
    \vfill
\end{titlepage}

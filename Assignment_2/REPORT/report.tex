...
``audio images'' can learn local time-frequency patterns --- the same spatial inductive
bias that makes CNNs powerful for vision --- without any hand-crafted acoustic features
like MFCCs.
